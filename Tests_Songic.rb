...
def test_note_modification_all
  ...
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "a# 2a# a#+1 2a#+1 a#-1 2a#-1 g# 2g# g#+1 2g#+1 g#-1 2g#-1 ", output + " " )
end
...
def test_dumb_notes
  ...
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "c+1 e ", output + " " )
end


def test_several_motifs_in_segment
  output = %x'ruby songic.rb ztests/several_motifs_in_segment.song'
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "a b c d e f g ", output + " " )
end
...
def test_several_segments_in_structure
  ...
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "a b c d d e f g ", output + " " )
end
...
def test_arithmetic_simple_subtraction
  ...
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "a b b-1 d e ", output + " " )
end
...
def test_arithmetic_combined_add_mult
  ...
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "a b g+1 d e ", output + " " )
end


def test_arithemtic_combined_mult_add
  output = %x'ruby songic.rb ztests/arithemtic_combined_mult_add.song'
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "a b g+1 d e ", output + " " )
end
...
def test_arithmetic_combined_mult_sub
  ...
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "a b b d e ", output + " " )
end


def test_arithemtic_combined_sub_mult
  output = %x'ruby songic.rb ztests/arithemtic_combined_sub_mult.song'
  output = output.split.join(" ")
  puts "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: #{output}"
  assert_equal( "a b c#-1 d e ", output + " " )
end
