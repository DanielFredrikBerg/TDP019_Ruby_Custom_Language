...
def test_if_simple_and_true
  output = StringIO.new
  $stdout = output
  output = %x'ruby songic.rb ztests/if_simple_and_true.song'
  output = output.split()
  #puts "After split: #{output}" #DEBUG
  output = output.join(" ")
  #puts "After join: #{output}" #DEBUG

  assert_equal( "d e f ", output.to_s + " " )
end


def test_if_simple_and_false
  output = StringIO.new
  $stdout = output
  output = %x'ruby songic.rb ztests/if_simple_and_false.song'
  output = output.split()
  #puts "After split: #{output}" #DEBUG
  output = output.join(" ")
  #puts "After join: #{output}" #DEBUG

  assert_equal( "e d g ", output.to_s + " " )
end


def test_if_simple_or_true
  output = StringIO.new
  $stdout = output
  output = %x'ruby songic.rb ztests/if_simple_or_true.song'
  output = output.split()
  #puts "After split: #{output}" #DEBUG
  output = output.join(" ")
  #puts "After join: #{output}" #DEBUG

  assert_equal( "f f f f f f ", output.to_s + " " )
end
...
def test_if_simple_less_than_true
  output = StringIO.new
  $stdout = output
  output = %x'ruby songic.rb ztests/if_simple_less_than_true.song'
  output = output.split()
  #puts "After split: #{output}" #DEBUG
  output = output.join(" ")
  #puts "After join: #{output}" #DEBUG
...
def test_if_simple_less_than_false
  output = StringIO.new
  $stdout = output
  output = %x'ruby songic.rb ztests/if_simple_less_than_false.song'
  output = output.split()
  #puts "After split: #{output}" #DEBUG
  output = output.join(" ")
  #puts "After join: #{output}" #DEBUG
...
def test_if_simple_more_than_true
  output = StringIO.new
  $stdout = output
  output = %x'ruby songic.rb ztests/if_simple_more_than_true.song'
  output = output.split()
  #puts "After split: #{output}" #DEBUG
  output = output.join(" ")
  #puts "After join: #{output}" #DEBUG
...
def test_if_simple_more_than_false
  output = StringIO.new
  $stdout = output
  output = %x'ruby songic.rb ztests/if_simple_more_than_false.song'
  output = output.split()
  #puts "After split: #{output}" #DEBUG
  output = output.join(" ")
  #puts "After join: #{output}" #DEBUG
